...
// // Define a minimum interval for AI analysis calls (e.g., 5 minutes)
// const MIN_AI_ANALYSIS_INTERVAL_MS = 5 * 60 * 1000; 
...
//         if (sessions.length > 0 && completionPercentage === 0) {
...
//       // This allows it to retry sooner than the MIN_AI_ANALYSIS_INTERVAL_MS
...
//       // Trigger progress analysis after adding session
//       // A small delay can help ensure state is fully updated before analysis
//       setTimeout(() => {
...
//   // This useEffect will trigger progress analysis when detailedSchedule changes or loads
//   // or when studySessions change (e.g., after adding a new session)
//   useEffect(() => {
//     if (userId && !detailedScheduleLoading) {
//       // Only run if detailedSchedule is loaded (or confirmed null)
//       // and there are study sessions to analyze, or if it's the initial load.
//       if (studySessions.length > 0 || detailedSchedule !== null) {
//         analyzeAndUpdateProgress();
//       }
//     }
//   }, [userId, detailedSchedule, detailedScheduleLoading, studySessions.length, analyzeAndUpdateProgress]);
...
//         // REMOVED: The line that artificially sets completionPercentage to 5%
//         // if (sessions.length > 0 && completionPercentage === 0) {
//         //   completionPercentage = 5;
//         // }
