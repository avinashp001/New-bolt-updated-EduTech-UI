...
import { Award, Target, CheckCircle, GaugeCircle } from 'lucide-react';
...
const PerformanceRing: React.FC<PerformanceRingProps> = ({
  ...
  <defs>
    <linearGradient id="progressGradient" gradientTransform="rotate(40)">
      {/* <stop offset="0%" stopColor="#67b037" /> */}
      <stop offset="20%" stopColor="#67b037" />
      {/* Remaining 75% Green */}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <div className="w-8 h-8 rounded-full flex items-center justify-center mx-auto mb-2">
              <GaugeCircle className="w-6 h-6 text-slate-800 dark:text-white" />
            </div>
