...
const BottomNavigationBar: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'help', label: 'Support', icon: MessageCircleQuestion, path: '/faq' },
  ];
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <item.icon
                className="w-6 h-6 mb-1 transition-transform duration-200 max-[450px]:w-5 max-[450px]:h-5"
              ...
              <span
                className={`max-[450px]:text-xs transition-colors duration-200 ${
                  active
                    ...
                    : 'text-gray-600 dark:text-gray-50 hover:text-blue-600 dark:hover:text-blue-300'
                }`}
              >
                {item.label}
              </span>
